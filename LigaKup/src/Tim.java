...
/**
* dodajIgraca funkcija koja prima sve parametre, kreira novog igraca i dodaje ga u niz.
 * @param ime
 * @param prezime
 * @param brojDresa
 * @param ocjenaBrzina
 ...
 */
public void dodajIgraca(String ime, String prezime, int brojDresa, double ocjenaBrzina, double ocjenaDodavanje, double ocjenaSut, double ocjenaSutGlavom) {

	timIgraca[brojIgraca] = new Igrac(ime, prezime, brojDresa, ocjenaBrzina, ocjenaDodavanje, ocjenaSut, ocjenaSutGlavom);
	brojIgraca++;
